...
namespace PracticeProblemDay9
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //EmpWage.EmpWageUC2.FindEmpWage();
            //EmpWage.PartTimeWageUC3.FindPartTimeWage();
            //EmpWage.EmpWageSwitchUC4.FindEmpWageSwitch();
            //EmpWage.EmpWageMonthUC5.FindEmpWageForMonth();
            //EmpWage.WageNumofDayUC6.FindWageofWorkingDays();
            //EmpWage.ComputeEmpWageUC7.ComputeEmpWage();
            //EmpWage.CompanyWageUC8.computeEmpWage(DMart, 1, 2, 3);
            //Console.ReadLine();
